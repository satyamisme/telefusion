...
from telefusion.errors import MessageIdsEmpty, PeerIdInvalid
from telefusion.parser import utils as parser_utils, Parser
...
class Message(Object, Update):
    ...
    async def wait_for_click(
        ...
        return await self._client.listen(
            filters=filters,
            timeout=timeout,
            listener_type=telefusion.enums.ListenerTypes.CALLBACK_QUERY,
