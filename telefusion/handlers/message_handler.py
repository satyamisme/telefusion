...
import telefusion
from telefusion.types import Message, Identifier
...
class MessageHandler(Handler):
    ...
    async def check_if_has_matching_listener(self, client: "telefusion.Client", message: Message):
        ...
        listener = client.get_listener_matching_with_data(data, telefusion.enums.ListenerTypes.MESSAGE)
    ...
    async def check(self, client: "telefusion.Client", message: Message):
        listener_does_match = (
    ...
    async def resolve_future_or_callback(self, client: "telefusion.Client", message: Message, *args):
