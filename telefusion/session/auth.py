...
from telefusion.connection import Connection
from telefusion.crypto import aes, rsa, prime
from telefusion.errors import SecurityCheckMismatch
from telefusion.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "telefusion.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
